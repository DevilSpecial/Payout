...
import com.example.payout.databinding.ActivityVelocityBinding

class SuperPremiumActivity : AppCompatActivity() {
    lateinit var binding: ActivitySuperPremiumBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivitySuperPremiumBinding.inflate(layoutInflater)
    ...
    private fun validateFields() {
        ...
        if (allFieldsFilled) {
            ...
            if(channel=="HPW Power"){
                bundle.putDouble("UpFront",0.0725)
                ...
                bundle.putDouble("Parivartan",0.0125)
