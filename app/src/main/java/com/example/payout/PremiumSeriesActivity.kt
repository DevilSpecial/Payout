...
import com.example.payout.databinding.ActivityPremiumSeriesBinding
import com.example.payout.databinding.ActivitySuperPremiumBinding
import com.example.payout.databinding.ActivityUpfrontT2Binding

class PremiumSeriesActivity : AppCompatActivity() {
    lateinit var binding: ActivityPremiumSeriesBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityPremiumSeriesBinding.inflate(layoutInflater)
    ...
    private fun validateFields() {
        ...
        if (allFieldsFilled) {
            ...
            if(channel=="HPW Power"){
                bundle.putDouble("UpFront",0.0675)
                ...
                bundle.putDouble("Parivartan",0.01)
                ...
                bundle.putDouble("InCountry",0.015)
                bundle.putDouble("Accl",0.005)
                bundle.putDouble("Strategic",0.00)
                bundle.putDouble("InStore",0.00)
